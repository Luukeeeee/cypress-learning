...
describe("Accomplishments Dashboard", () => {
  ...
  it("should display inappropriate content error when text or accomplishment includes giraffe is submitted", () => {
  ...
  it("should display inappropriate content error when text or accomplishment includes giraffe is submitted (with mock)", () => {
